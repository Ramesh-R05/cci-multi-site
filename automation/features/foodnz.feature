@smoketestfoodnz
Feature: Smoke test for FOOD NZ
    As a user
...
# We will enable this scenario once we start using the tags of this GA ID on FOODNZ
#    Scenario: I can see the GA container with id "UA-8689488-1"
#        When I am currently viewing the homepage
#        Then I should see the GA container id "UA-8689488-1" on the DOM

# We will enable this scenario once it is ready to create items in FOODNZ CMS
...
#We will enable this scenario once we use the DEV FOODNZ CMS
