...
multi-site provides a bootstrapped, mobile first, responsive, website running on a Flux and BFF based architecture. It is an opinionated set of constrains that favours rapid delivery over bespoke designs. Home, listing (section, sub section, tag listing), article and gallery pages are included.
