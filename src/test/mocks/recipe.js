export default {
    ...
    path: ['GT--1', 'GT-1159', 'GT-1184', 'GT-1187', 'GT-1447', 'GT-1448', 'GT-2128'],
    level: 6,
    nodeId: 'GT-2128',
    ...
    contentVideo: '',
    contentAuthor: ['GT-2129'],
    nodeTypeAlias: 'Recipe',
    contentAuthors: ['GT-2129'],
    ...
    contentImageUrl:
        'http://d3lp4xedbqa8a5.cloudfront.net/s3/digital-cougar-assets/GourmetTraveller/2013/05/07/4229/1112GT-classic-chilli-crab-628.jpg',
    contentProfiles: [
        {
            id: 'GT-2129',
            ...
            level: 3,
            title: 'Alice Storey',
            pathIds: ['GT--1', 'GT-1159', 'GT-1166', 'GT-2129'],
            siteUrl: 'http://gt-site-au.sit.bxm.net.au',
    ...
    recipeCookingMethod: [
        ...
        },
        {
            ...
            methods: [
                {
                    method:
                        'Add chilli paste and stir until tender (7-10 minutes). Add ginger and garlic, stir until fragrant (2-3 minutes). Add tomato paste and stir until mixture darkens in colour (1-2 minutes).'
                }
            ]
        }
    ],
